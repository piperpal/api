...
function updateGeo() {
    ...
    window.location.href = 'https://api.piperpal.com/location/json.php?service=Restaurant&glat=' + position.coords.latitude + '&glon=' + position.coords.longitude;
...
<span id='status_publisher'></span>
    <input id="glat" name="glat" />
    <input id="glon" name="glon" />    
</body>
</html>
